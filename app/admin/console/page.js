    ...
    <div className="page-stack">
      ...
      <section className="panel-card">
        <div className="panel-header">
          <div>
            <h2>Console Admin</h2>
            <p>Una sede alla volta, con sezioni tecniche divise per argomento.</p>
          </div>
        ...
        <div className="permission-role-strip">
          ...
          <div className="summary-chip">
            ...
            <span>feature attive</span>
          </div>
          <div className="summary-chip">
            <strong>{technical.manageLinkDeliveryMode || "SMS"}</strong>
            <span>canale link cliente</span>
          </div>
        </div>
      </section>
      ...
      <section className="panel-card">
        ...
        <form action={saveAdminConsoleLocationAction} className="entity-form">
          ...
          <fieldset className="form-fieldset" disabled={!canManageConsole}>
            <section
              className="console-section-panel"
              hidden={selectedSection !== "generale"}
            >
              <div className="console-section-header">
                <div>
                  <h3>Generale</h3>
                  <p>Identita della sede, feature operative e recapiti di base.</p>
                </div>
              </div>
            ...
            <section
              className="console-section-panel"
              hidden={selectedSection !== "comunicazioni"}
            >
              <div className="console-section-header">
                <div>
                  <h3>Comunicazioni</h3>
                  <p>SMS, template stato, link cliente ed SMTP.</p>
                </div>
              </div>
            ...
            <section
              className="console-section-panel"
              hidden={selectedSection !== "integrazioni"}
            >
              <div className="console-section-header">
                <div>
                  <h3>Integrazioni</h3>
            ...
            <section
              className="console-section-panel"
              hidden={selectedSection !== "operativita"}
            >
              <div className="console-section-header">
                <div>
                  <h3>Operativita</h3>
